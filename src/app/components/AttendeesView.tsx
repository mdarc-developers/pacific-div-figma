...
import { ExternalLink, Info, Send, User } from 'lucide-react';
...
function AttendeeCard({ attendee, isHighlighted }: AttendeeCardProps) {
  ...
  function displayCallsign(call: string) {
      if (call) {
      }
  }
          ...
          <div className="flex space-y-2 gap-2 justify-between items-start">
            ...
            <CardTitle className="flex text-lg mb-2 w-full gap-2 space-y-2">
              ...
              <a
                ...
                href={`https://www.qrz.com/db/${attendee.callsign}`}
                rel="noopener noreferrer"
                target="_blank"
              >
                {attendee.callsign}&nbsp;<ExternalLink className="flex h-4 w-4" />
              </a>
            </CardTitle>
