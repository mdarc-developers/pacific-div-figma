...
// ── Tests ─────────────────────────────────────────────────────────────────────
describe("UserAdminSearch (unauthenticated)", () => {
  it("renders without crashing", () => {
    mockUser = null;
    mockLoading = false;
    mockIsUserAdmin = false;
    expect(() => renderUserAdminSearch()).not.toThrow();
  });
...
describe("UserAdminSearch (authenticated, non-admin)", () => {
...
describe("UserAdminSearch (authenticated, user-admin)", () => {
...
describe("UserAdminSearch (search interactions)", () => {
  beforeEach(() => {
    mockUser = { email: "admin@example.com", uid: "uid-admin" };
    mockLoading = false;
    mockIsUserAdmin = true;
