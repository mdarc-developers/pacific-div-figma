    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-4">
        ...
        <p className="text-sm text-gray-500">
          ...
          to access sessions management.
        </p>
      </div>
    );
  }

  // Signed in but not in the session-admin group
  if (!isSessionAdmin) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-4">
        ...
        <p className="text-sm text-gray-500">
          Your account does not have session-admin group membership.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="w-full">
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
        Add, edit, or remove sessions for the active conference.
      </p>
      <SessionAdminView
