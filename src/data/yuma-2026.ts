...
export const mapSessions: [string, Session[]] = [
  ...
  [
    // ── Seminar Room 1 (Fine Arts Building) ──────────────────────────────────
    {
      ...
      description: 'A look at hints and tips for kit builders from beginners to advanced. We look at the proper tools, test equipment and work surface needed to have the best chance at success enjoying this very rewarding part of amateur radio.',
    ...
    },
    {
      ...
      description: 'Review of VSWR how it affects transmitting and receiving and followed by how to measure VSWR using an inexpensive Nano VNA.',
    ...
    },
    {
      ...
      description: "Is your transmitter the SOURCE of RFI affecting electronic devices in your own house or your neighbor's house? Are you the VICTIM of RFI from your own electronic devices or from devices in your neighborhood? Do you want to reduce your receiver noise floor so you can hear local contacts and more DX? If you answered YES to any of these questions and would you like to find a quick and easy solution, then you should attend this presentation.",
    ...
    },
    {
      ...
      description: 'This talk will give a basic overview of the underlying technology (LoRa), the similarities and differences between Meshtastic and Meshcore, as well as some recommendations for which to use in different scenarios. I will also have a variety of devices to show.',
    ...
    },
    {
      ...
      description: 'Carl, KB7AZ, is the Arizona Section Technical Coordinator. He will present the new rules and how to be compliant with those rules. Compliance is not difficult, but just takes a little time and effort.',
      speaker: ['Carl Foster (KB7AZ)'],
      location: 'Seminar Room 1 (Fine Arts Building)',
    ...
    },
    {
      ...
      description: 'Joe will share his experience at the Consumer Electronics Show 2026 in Las Vegas. Included will be the up and coming and new innovations. Joe will have a slideshow of his experience.',
      speaker: ['Joe Eisenberg (K0NEB)'],
      location: 'Seminar Room 1 (Fine Arts Building)',
    ...
    {
      id: 'yuma-session-10',
      title: 'End Fed Antenna Secrets for Portable, Emergency and Stealth Installations',
      description: 'Learn how to select, choose and setup an end fed antenna system that works on multiple bands, is stealthy and radiates well at low heights. Find out the secrets of antenna matching, reducing RFI and minimizing noise present on many end fed antennas. Example installations and antenna dimensions will be shown for 160-6 meter operations.',
      speaker: ['Bob Brehm (AK6R)'],
    ...
    // ── Hospitality Seminars (Old Theater Building) ───────────────────────────
    {
      ...
      description: 'A condensed version of the National Weather Service Skywarn Spotter Training Refresher. This refresher is recommended every other year in order to keep you up to date and informed as a Skywarn Spotter.',
      speaker: ['Tom Frieders (National Weather Service)', 'Ted Whittock (National Weather Service)'],
    ...
    },
    {
      id: 'yuma-session-20',
      title: 'Rope Baskets',
      description: 'I became interested in designs using rope and fabric two years ago when a friend shared what she had learned at a quilt store class. I was immediately hooked, and as my hubby says, addicted. Soon I had baskets, trivets, wall hangings and table runners galore! My favorite challenge is to create rope art that looks like pottery. Come enjoy creating Rope Baskets with me!',
    ...
    },
    {
      id: 'yuma-session-21',
      title: 'Family Search',
      description: 'I am a Family Search Consultant. Over the years I have gathered many stories, pictures, and worked with Ancestory.com, Family Search and other genealogy sites. I hope I will be able answer your questions that you may have, how to begin, finding one special story, or that one relative you do not know anything about or are just curious who you look like. Come search with me!',
    ...
    },
    {
      id: 'yuma-session-22',
      title: 'Sewing Tips',
      description: "Brenda's Quilting Studio is a small, family owned, longarm quilting business located in the Yuma foothills area for over 20 years. With a background in custom tailoring-including formals and wedding alterations-Brenda brings deep expertise in fabric, fit and finishing to all she does. Today, she is passionate about helping quilters of all skill levels achieve a beautiful, professional finish on their hand-created quilts. Come join Brenda for Sewing tips!",
