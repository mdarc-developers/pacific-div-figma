...
export const mapExhibitors: [string, Exhibitor[]] = [
  ...
  [
    ...
    // ── Swap meet / tailgate (green / available) ──────────────────────────
    {
      id: 'mini-pancakes',
      name: 'Mini Pancakes',
      description: 'Patricia Lopez — mini pancakes, cash only',
      boothName: '23',
      location: [23],
      type: 'food',
      color: '#fde047',
    ...
    },
    {
      ...
      description: 'Ken McMurdie — firearms and accessories',
      boothName: '31',
      location: [31],
      type: 'vendor-booth',
      color: '#86efac',
    ...
    },
    {
      id: 'rv-connection',
      name: 'RV Connection',
      description: 'Thomas Bulinski — RV accessories and supplies',
      boothName: '32',
      location: [32],
      type: 'vendor-booth',
      color: '#86efac',
    ...
    },
    {
      ...
      description: 'Richard Hammerschlag — electronics and amateur radio equipment',
    ...
    },
    {
      ...
      description: 'Girl Scouts — cookies and refreshments',
      boothName: '38',
      location: [38],
      type: 'food',
      color: '#86efac',
    ...
    // ── Right-side club / organization row ────────────────────────────────
    {
      id: 'club-row',
      name: 'Club Row',
      description: 'Area reserved for amateur radio clubs — information and membership',
      boothName: '45',
      location: [45],
      type: 'club-booth',
      color: '#fde047',
    ...
    },
    {
      ...
      description: 'Bob Brehm — RFI filters, chokes and ferrite products',
      boothName: '53  54',
      location: [53, 54],
      type: 'vendor-booth',
      color: '#fde047',
