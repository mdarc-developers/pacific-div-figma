...
export const mapExhibitors: [string, Exhibitor[]] = [
  ...
  [
    ...
    },
    {
      ...
      description:
        "Seller of high-power flashlights, kitchen, knives, high power magnets, pocket knives, tools and much more",
      boothName: "T-1",
      location: [30],
      type: "vendor-booth",
      color: "#77cff4",
    ...
    },
    {
      ...
      name: "Compudigital",
      description:
        "We build Power Supply and PA rebuilding kits for the Kenwood TS-2000, TS-940, and TS-930 transceivers. ",
      boothName: "T-14",
      location: [42],
      type: "vendor-table",
      color: "#FFC000",
    ...
    },
    {
      ...
      name: "Bioenno Power",
      description:
        "LiFePO4 batteries and solar products for ham radio applications.",
      boothName: "T-16",
      location: [44],
      type: "vendor-table",
      color: "#FFC000",
    ...
    },
    {
      ...
      description:
        "The Jeffrey Dahn Memorial Foundation champions education in electronics for African youth, leveraging amateur radio to inspire innovation and unlock opportunities.",
      boothName: "NP-14",
      location: [47],
      type: "nonprofit-table",
      color: "#FFFF00",
    ...
    },
    {
      ...
      description:
        "Parachute Mobile's 14th year providing a unique combination of skydiving and ham radio.",
      boothName: "NP-11",
      location: [51],
      type: "nonprofit-table",
      color: "#FFFF00",
    ...
    },
    {
      ...
      name: "USS Hornet ARC",
      description:
        "A radio club on board the USS Hornet Air Sea and Space Museum. We promote amateur radio through our station NB6GC.",
      boothName: "NP-10",
      location: [52],
      type: "nonprofit-table",
      color: "#FFFF00",
    ...
    },
    {
      ...
      boothName: "NP-2",
      description:
        "We provide a free-to-all microwave network around the Bay Area for AREDN, repeater linking, and other uses by the amateur radio community.",
      location: [66],
      type: "nonprofit-table",
      color: "#FFFF00",
    ...
    },
    {
      ...
      boothName: "NP-4",
      description:
        "International club focused on all forms of communication and technology including amateur radio, education, service and camaraderie.",
      location: [68],
      type: "nonprofit-table",
      color: "#FFFF00",
    ...
    },
    {
      ...
      name: "FreeDV",
      description:
        "FreeDV is an open-source digital voice mode designed for use on the HF bands. Using machine learning techniques, we have achieved audio quality surpassing traditional modes.",
      boothName: "37",
      location: [75],
      type: "vendor-booth",
      color: "#77cff4",
    ...
    },
    {
      ...
      description:
        "Functional artistic pottery handmade by a master potter. Wares include Ham mugs and dragon mugs. Additionally, call sign bracelets for both men and women will be crafted on-site.",
      boothName: "41",
      location: [77],
      type: "vendor-booth",
      color: "#77cff4",
    ...
    },
    {
      ...
      description:
        "Learn morse code with the Long Island CW Club—live daily online classes (beginner–advanced) with a QSO-focused curriculum, plus daily forums, POTA/SOTA outings, and historic special-event operations.",
      boothName: "34   35",
      location: [83, 84],
      type: "vendor-booth",
      color: "#77cff4",
    ...
    },
    {
      ...
      name: "AI6YM.Radio",
      description:
        "Amateur radio kits and accessories. Always open source because you should be tinkering with your ham gear.",
      boothName: "36",
      location: [85],
      type: "vendor-booth",
      color: "#77cff4",
...
export const mapSessions: [string, Session[]] = [
  ...
  [
    ...
    },
    {
      ...
      description:
        "Experts talking about all kinds of antennas, classic and new.",
      speaker: ["TBA"],
      location: "Salon E,F,G,H (300)",
    ...
    },
    {
      ...
      description: "Meet in Hotel Lobby then walk to Panera",
      speaker: [],
      location: "Hotel Lobby",
    ...
    },
    {
      ...
      title: "Fri Prize Drawing 8:30PM",
    ...
    },
    {
      ...
      title:
        "Building an amateur radio community Malawi & Comoros, Africa from the ground up",
      description: "",
    ...
    },
    {
      ...
      title:
        "Scouting Venture Crew 73... Radio & electronics Merit badges and STEM",
      description: "",
    ...
    },
    {
      ...
      title:
        "Construction Techniques for Homebrew Projects for Hams.  Why?  How?  Sources?",
      description: "",
    ...
    },
    {
      ...
      title:
        "Multi-County Aux Communication Functional Exercise panel discussion",
      description: "",
...
export const sampleAttendees: UserProfile[] = [
  ...
  },
  {
    ...
    displayProfile: "Pacificon event coordinator",
    darkMode: false,
    bookmarkedSessions: [],
    notificationsEnabled: false,
    smsNotifications: false,
  ...
  },
  {
    ...
    displayProfile: "HF propagation and antenna design",
    darkMode: false,
    bookmarkedSessions: [],
    notificationsEnabled: false,
    smsNotifications: false,
  ...
  },
  {
    ...
    displayProfile: "Ham radio licensing educator and author",
    darkMode: false,
    bookmarkedSessions: [],
    notificationsEnabled: false,
    smsNotifications: false,
  ...
  },
  {
    ...
    displayProfile: "SDR and digital modes vendor",
    darkMode: false,
    bookmarkedSessions: [],
    notificationsEnabled: false,
    smsNotifications: false,
