...
export default defineConfig({
  ...
  test: {
    ...
    // Exclude the entire functions/ subtree (TypeScript sources + compiled
    // CommonJS output) — Cloud Function tests have their own package and must
    // be run separately: cd functions && npm test
