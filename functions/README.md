...
This directory contains the Firebase Cloud Functions for the Pacific Division Conference App.
...
### 2. Create a service account for Gmail delegation
...
2. Add the client ID from step 3 and authorize the scope:
   ```
   https://www.googleapis.com/auth/gmail.send
   ```

### 5. Configure the runtime service account
...
| `FUNCTION_SERVICE_ACCOUNT` | Compute Engine default SA email — set in `functions/.env` (see Prerequisites §5) |
